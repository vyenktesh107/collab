...
import com.UIBS.Enquiry_Module.model.ApiResponce;
...
public class RestExceptioinHandler {
	...
	public ResponseEntity<ApiResponce> handleCustomeExceptionStatus(EnquiryNotSubmitException e, HttpServletRequest request){
		
		log.info("handleCustomeExceptionStatus APIResponce Executed");
	...
	public ResponseEntity<Map<String, String>> handleMethodArgsNotValidException(MethodArgumentNotValidException ex, HttpServletRequest request){
		...
		Map<ApiResponce,Map<String, String>> allresp = new HashMap<>();
		...
		log.info("handleMethodArgsNotValidException Responce generated with fiels and default message");
