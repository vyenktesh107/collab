...
//	@Override
//	public Iterable<Enquiry> getMobEnquiry() {
//		
//        log.info("Enquiry by MobileNo executed");
//		
//		List<String> li = new ArrayList<String>();
//		List<Enquiry> al = er.findByMobileNo();
//		
//		
//		return null;
//	}
	...
	@Override
	public Enquiry getEnquiryByMob(String mobileNo) {
		
		Enquiry findEnquiryByMobileNo = er.findByMobileNo(mobileNo);
		return findEnquiryByMobileNo;
	}
